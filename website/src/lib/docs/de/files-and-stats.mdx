...
Darüber hinaus ermöglicht die Dateibaumansicht die Prüfung der [Tracks, Segmente und Wegpunkte](./gpx), die in den Dateien durch zusammenklappbare Abschnitte enthalten sind.
...
Um die Statistiken für einen bestimmten Abschnitt des Höhenprofils zu erhalten, können Sie mit der rechten Maustaste ein Auswahlrechteck auf das Profil ziehen.
Klicken Sie mit der rechten Maustaste auf das Profil, um die Auswahl zurückzusetzen.

Sie können auch das Mausrad verwenden, um auf dem Höhenprofil heran- und herauszuzoomen und sich nach links und rechts zu bewegen, indem Sie das Profil mit der linken Maustaste ziehen.
...
- **Oberfläche** oder **Kategorie** Daten aus <a href="https://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>'s <a href="https://wiki.openstreetmap.org/wiki/Key:surface" target="_blank">surface</a> and <a href="https://wiki.openstreetmap.org/wiki/Key:highway" target="_blank">highway</a> tags.
  Dies ist nur für Dateien verfügbar, die mit **GoTrails** erstellt wurden.
