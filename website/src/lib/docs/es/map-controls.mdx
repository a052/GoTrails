...
Los controles del mapa se encuentran en la parte derecha de la interfaz.
...
Solo funciona si ha permitido que su navegador y <b>GoTrails</b> accedan a su ubicación.
...
Una gran colección de mapas y capas superpuestas globales y locales está disponible en **GoTrails**, así como una selección de categorías de puntos de interés.
