...
La barra de herramientas se encuentra a la izquierda del mapa y es el corazón de la aplicación ya que proporciona acceso a las principales características de **GoTrails**.
