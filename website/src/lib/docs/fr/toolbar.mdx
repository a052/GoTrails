...
La barre d'outils est située sur le côté gauche de la carte et est le cœur de l'application, puisqu'elle permet d'accéder aux fonctionnalités principales de **GoTrails**.
